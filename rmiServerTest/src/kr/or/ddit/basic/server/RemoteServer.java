...
public class RemoteServer extends UnicastRemoteObject implements RemoteInterface{
	...
	public static void main(String[] args) {
		try {
			...
			// 	  (이 때의 변수는 RMI용 인터페이스 자료형으로 선언한다.)
			...
			//	등록방법 : Registry객체변수.rebind("객체의Alias", RMI용 객체의 인스턴스);
	...
	// 클라이언트가 보내온 파일 정보를 이용하여 서버쪽에 해당 파일을 저장하는 메소드
	@Override
	public void setFile(FileInfoVO fileVo) throws RemoteException {
		...
		try {
			...
			// 클라이언트에서 보내온 파일 데이터(byte배열)를 저장한다.
