...
public class FileTest01 {
	...
	public static void main(String[] args) {
		...
		//			'\'를 사용하거나 '/'를 사용할 수 있다.
//		File file1 = new File("D:/D_Other/test.txt"); // 구분 문자는 '/'로 사용
		File file1 = new File("D:\\D_Other\\test.txt"); // 구분 문자는 '\'로 사용
		...
		//			⇒ 'parent' 디렉토리 안에 있는 'child' 파일을 찾는다.
		...
		//				==> 반환값 : 만들기 성공하면 true, 실패하면 false
//						==> 경로의 중간부분의 폴더(디렉토리)들이 모두 존재해야 한다.
