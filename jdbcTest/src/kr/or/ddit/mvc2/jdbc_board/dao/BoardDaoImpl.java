...
public class BoardDaoImpl implements IBoardDao{
	...
	public List<BoardVo> getAllBoard() {
		...
		try {
			...
			conn = DBUtil.getConnection();
			String sql = "SELECT BOARD_NO, BOARD_TITLE, BOARD_WRITER, BOARD_DATE, BOARD_CNT FROM JDBC_BOARD ORDER BY BOARD_NO";
			ps = conn.prepareStatement(sql);
			rs = ps.executeQuery();
	...
	public List<BoardVo> getAllTitle(String title) {
		...
		try {
			conn = DBUtil.getConnection();
			String sql = "SELECT BOARD_NO, BOARD_TITLE, BOARD_WRITER, BOARD_DATE, BOARD_CNT FROM JDBC_BOARD WHERE BOARD_TITLE LIKE ? ORDER BY BOARD_NO";
			ps = conn.prepareStatement(sql);
